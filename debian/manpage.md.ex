% raw2fits(SECTION) | User Commands
%
% "November 23 2024"
...
raw2fits - program to do something

# SYNOPSIS

**raw2fits** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**raw2fits** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **raw2fits** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**raw2fits** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    raw2fits. See **foo.conf**(5) for further details.
...
**raw2fits** provides some return codes, that can be used in scripts:
